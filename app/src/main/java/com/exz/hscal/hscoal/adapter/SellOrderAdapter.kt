...
import com.exz.hscal.hscoal.bean.SellOrderBean
...
class SellOrderAdapter() : BaseQuickAdapter<SellOrderBean, BaseViewHolder>(R.layout.item_sell_order, null) {

    override fun convert(helper: BaseViewHolder, item: SellOrderBean) {
