...
class ReleaseCocalActivity : BaseActivity() {
    ...
    private fun initListData() {
        ...
        data1.add(ReleaseBean(1, "可供吨数(吨):", "请输入可供吨数", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data1.add(ReleaseBean(1, "单价(元):", "请输入单价", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 15))
        data1.add(ReleaseBean(2, "付款方式:", "请选择", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data1.add(ReleaseBean(3, "交货时间:", "", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data1.add(ReleaseBean(2, "交货方式:", "请选择", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data1.add(ReleaseBean(1, "交货地点:", "请输入", "0", InputType.TYPE_CLASS_TEXT, 0))
        ...
        data2.add(ReleaseBean(1, "可供吨数(吨):", "请输入可供吨数", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data2.add(ReleaseBean(1, "单价(元):", "请输入单价", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 15))
        data2.add(ReleaseBean(2, "付款方式:", "请选择", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data2.add(ReleaseBean(3, "交货时间:", "", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data2.add(ReleaseBean(2, "交货方式:", "请选择", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data2.add(ReleaseBean(1, "交货地点:", "请输入", "0", InputType.TYPE_CLASS_TEXT, 0))
        ...
        data3.add(ReleaseBean(1, "灰份(%[选填]):", "请输入值", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data3.add(ReleaseBean(1, "灰熔点(选填):", "请输入值", "0", InputType.TYPE_CLASS_TEXT, 0))
        data3.add(ReleaseBean(2, "G值(选填):", "请选择", "0", InputType.TYPE_CLASS_TEXT, 0))
        data3.add(ReleaseBean(2, "Y值(mm[选填]):", "请输入值", "0", InputType.TYPE_CLASS_TEXT, 15))
        data3.add(ReleaseBean(1, "可供吨数(吨):", "请输入可供吨数", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data3.add(ReleaseBean(1, "单价(元):", "请输入单价", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 15))
        data3.add(ReleaseBean(2, "付款方式:", "请选择", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data3.add(ReleaseBean(3, "交货时间:", "", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data3.add(ReleaseBean(2, "交货方式:", "请输入值", "0", InputType.TYPE_NUMBER_FLAG_DECIMAL, 0))
        data3.add(ReleaseBean(1, "交货地点:", "请输入", "0", InputType.TYPE_CLASS_TEXT, 0))
        ...
        data3.add(ReleaseBean(5, "点击上传检测报告照片:", "0", "0", InputType.TYPE_CLASS_TEXT, 15))
        data3.add(ReleaseBean(5, "点击上传产品照片:", "0", "0", InputType.TYPE_CLASS_TEXT, 0))
